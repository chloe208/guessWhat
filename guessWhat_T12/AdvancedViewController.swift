    ...
    @IBAction func checkBtn(_ sender: Any) {
        ...
        if (guessAnswer == correctAnswer) {
            ...
            let okAction = UIAlertAction(title: "OK", style: .default, handler: { (action) -> Void in
                ...
                let AdvancedViewController2 = storyBoard.instantiateViewController(withIdentifier: "AdvancedViewController2") as! AdvancedViewController2;
                self.present(AdvancedViewController2, animated: true, completion: nil);
            })
